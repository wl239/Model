...
df = pd.read_excel('cleaned_ik_gaussian.xlsx')      # <================================================================================ CHANGE !!!
cleaned_df = clean_data(df)

file_path = './image/synthetic_ik/synthetic_ik'   # <================================================================================ CHANGE !!!
...
save_report_as_png(ols_report, 'synthetic_ik')  # Save ols summary as a picture   # <================================================================================ CHANGE !!!
save_report_as_text(ols_report, 'synthetic_ik')  # Save ols summary as a text     # <================================================================================ CHANGE !!!
...
print("T value: %f" % t_value)  # when n = 5, 0.841130, explained variance ratio
pca_df.columns = ['pc1', 'pc2', 'pc3', 'pc4', 'pc5']
pca_df.to_excel('pca_synthetic_ik.xlsx')         # <=================================================================================== CHANGE !!!
...
result4 = comparison_regression(model_list, 'pca_synthetic_ik', x_pca, y_pca, x_pca_train, x_pca_test, y_pca_train, y_pca_test)  # <=================================================================================== CHANGE !!!

df_result4 = pd.DataFrame(result4, columns=['Method', 'Goodness of fit']).set_index(['Method'])
save_dataframe_as_png(df_result4, "image/pca_synthetic_ik/pca_synthetic_ik_regression")     # <=================================================================================== CHANGE !!!
