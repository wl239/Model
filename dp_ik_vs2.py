...
file_path = './image/dp_ik2/dp_ik2'   # <================================================================================ CHANGE !!!
...
save_report_as_png(ols_report, 'dp_ik2')  # Save ols summary as a picture   # <================================================================================ CHANGE !!!
save_report_as_text(ols_report, 'dp_ik2')  # Save ols summary as a text     # <================================================================================ CHANGE !!!
...
print("T value: %f" % t_value)  # when n = 5, T value: 0.560281, explained variance ratio
pca_df.columns = ['pc1', 'pc2', 'pc3', 'pc4', 'pc5']
pca_df.to_excel('pca_dp_ik2.xlsx')         # <=================================================================================== CHANGE !!!
...
result4 = comparison_regression(model_list, 'pca_dp_ik2', x_pca, y_pca, x_pca_train, x_pca_test, y_pca_train, y_pca_test)  # <=================================================================================== CHANGE !!!

df_result4 = pd.DataFrame(result4, columns=['Method', 'Goodness of fit']).set_index(['Method'])
save_dataframe_as_png(df_result4, "image/pca_dp_ik2/pca_dp_ik2_regression")     # <=================================================================================== CHANGE !!!
