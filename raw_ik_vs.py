...
pca_df.to_excel('pca_raw_ik.xlsx')         # <=================================================================================== CHANGE !!!
...
result4 = comparison_regression(model_list, 'pca_raw_ik', x_pca, y_pca, x_pca_train, x_pca_test, y_pca_train, y_pca_test)  # <=================================================================================== CHANGE !!!

df_result4 = pd.DataFrame(result4, columns=['Method', 'Goodness of fit']).set_index(['Method'])
save_dataframe_as_png(df_result4, "image/pca_raw_ik/pca_raw_ik_regression")     # <=================================================================================== CHANGE !!!
