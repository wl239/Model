...
# save_as_png(report, 'raw_ik_y2_knn')
...
df_result1 = pd.DataFrame(result1, columns=['Method', 'Regression - MSE']).set_index(['Method'])
df_result2 = pd.DataFrame(result2, columns=['Method', 'Classification1 - Accuracy']).set_index(['Method'])
df_result3 = pd.DataFrame(result3, columns=['Method', 'Classification2 - Accuracy']).set_index(['Method'])
